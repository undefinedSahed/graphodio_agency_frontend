...
export const blogs = [
    ...
    },
    {
            ...
            secondTitle: "The Myth of “Spend More, Sell More”",
            ...
            secondPara: "Many sellers believe that the quickest way to win on Amazon is simply increasing ad budgets. While spend does influence visibility, it often leads to wasted clicks and inflated ACOS if not backed by proper targeting.",
            thirdTitle: "A Smarter Approach to Amazon PPC",
            thirdPara: "At Graphodio, we design PPC campaigns around:",
            fourthPara: "● Keyword Segmentation – separating branded, competitor, and category keywords for clear insights.\n● Phased Launches – rolling out campaigns gradually so Amazon’s algorithm can optimize effectively.\n● Conversion-Centric Targeting – focusing spend on proven converting terms instead of chasing vanity impressions.\n● Data-Driven Scaling – growing campaigns only when profitability is consistent.",
            secondImage: "/images/blog.jpg",
            secondImgDes: "",
            fourthTitle: "Why Strategy Wins",
            fifthPara: "By treating PPC as a profit engine rather than a spend sink, sellers can achieve sustainable growth while keeping margins healthy.",
            sixthPara: "If your Amazon ads feel like an expense instead of an investment, let Graphodio show you how strategy turns spend into sustainable profit.",
