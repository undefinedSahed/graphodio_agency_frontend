                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      filter:
                        hovered === work.title ? "blur(8px)" : "blur(3px)",
                    }}
                  />
            ...
            >
              <div
                ...
                style={{
                  ...
                  backgroundPosition: "center",
                  filter:
                    hovered === works[2].title ? "blur(8px)" : "blur(3px)",
                }}
              />
              <div className="relative z-10 w-full h-full p-4 sm:p-6 flex items-center justify-center">
                <Image
            ...
            >
              <div
                ...
                style={{
                  ...
                  backgroundPosition: "center",
                  filter:
                    hovered === works[3].title ? "blur(8px)" : "blur(3px)",
                }}
              />
              <div className="relative z-10 w-full h-full p-4 sm:p-6 flex items-center justify-center">
                <Image
            ...
            >
              <div
                ...
                style={{
                  ...
                  backgroundPosition: "center",
                  filter:
                    hovered === works[4].title ? "blur(8px)" : "blur(3px)",
                }}
              />
              <div className="relative z-10 w-full h-full p-4 sm:p-6 flex items-center justify-center">
                <Image
